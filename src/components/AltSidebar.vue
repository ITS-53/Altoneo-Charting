  ...
  >
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
      ...
      >
        ...
        <p
          v-if="item.heading"
          class="px-3 pt-4 pb-1 text-[10px] uppercase tracking-wider text-altoneo-400"
        ...
        >
          ...
          <span
            ...
            class="ml-auto rounded-full bg-altoneo-700 text-white text-[11px] px-1.5 py-0.5"
          >
            {{ item.badge }}
          </span>
        </component>
    ...
    <div
      ...
      class="border-t border-altoneo-700 p-2 shrink-0"
    >
      <slot
        name="footer"
        :collapsed="collapsed"
