<template>
  <div class="flex flex-col items-center justify-center text-center py-12 px-6">
    <div class="w-14 h-14 rounded-full bg-altoneo-50 dark:bg-alt-dark-raised text-altoneo-400 dark:text-altoneo-100 flex items-center justify-center mb-4">
      <slot name="icon">
        <svg
          class="w-7 h-7"
          viewBox="0 0 24 24"
    ...
    <p
      v-if="description"
      class="mt-1 text-sm text-gray-500 dark:text-alt-dark-muted max-w-sm"
    >
      {{ description }}
    </p>
    <div
