  ...
  >
    ...
    >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <AltInput
            ...
            @blur="form.handleBlur('firstName')"
          />
        </AltFormField>
        <AltFormField
          label="Nom"
      ...
      <AltFormField
        ...
        required
        :error="form.touched.confirm ? form.errors.confirm : ''"
      >
        <AltInput
          ...
          @blur="form.handleBlur('confirm')"
        />
      </AltFormField>

      <div>
        <AltCheckbox
          v-model="form.values.cgu"
          @change="form.handleBlur('cgu')"
        >
          J'accepte les <a
            v-if="termsHref"
            :href="termsHref"
            class="text-altoneo-500 dark:text-alt-dark-link hover:underline"
          >conditions d'utilisation</a><span v-else>conditions d'utilisation</span>
        </AltCheckbox>
        <p
          v-if="form.touched.cgu && form.errors.cgu"
